...
const TabunganDepositoKoperasiBankLainPage: React.FC<TabunganDepositoKoperasiBankLainPageProps> = ({ onChange }) => {
                ...
                <div className="grid">
                    <div className="col-12 md:col-6">
                        <div className="field">
                            ...
                            <div className="flex align-items-center">
                                <RadioButton inputId="tabungan" name="jenis" value="tabungan" onChange={handleRadioChange} className="mr-2" />
                                <label htmlFor="tabungan" className="mr-4">Tabungan</label>
                                <RadioButton inputId="deposito" name="jenis" value="deposito" onChange={handleRadioChange} className="mr-2" />
                                <label htmlFor="deposito">Deposito</label>
                            </div>
                        </div>
                        <div className="field">
                            <label htmlFor="noBilyet" className="block text-900 font-medium mb-2">No. Bilyet</label>
                            <InputText id="noBilyet" name="noBilyet" onChange={handleInputChange} className="w-full" />
                        </div>
                        <div className="field">
                    ...
                    <div className="col-12 md:col-6">
                        <div className="field">
                            ...
                            <InputText id="noRekening" name="noRekening" onChange={handleInputChange} className="w-full" />
                        </div>
                        <div className="field">
                            <label htmlFor="nominal" className="block text-900 font-medium mb-2">Nominal</label>
                            <InputText id="nominal" name="nominal" onChange={handleInputChange} className="w-full" />
                        </div>
                        <div className="field">
